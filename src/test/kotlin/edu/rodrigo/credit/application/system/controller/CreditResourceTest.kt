...
class CreditResourceTest {
    ...
    fun `should create a credit and return 201 status`() {
        ...
        mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.dayFirstOfInstallments").value("LocalDate.now()"))
    ...
    private fun builderCreditDto(
            ...
            dayFirstOfInstallments: LocalDate = LocalDate.now(),
            numberOfInstallments: Int = 5,
            customerId: Long = 2,
    ) = CreditDto(
            creditValue = creditValue,
            dayFirstOfInstallments = dayFirstOfInstallments,
